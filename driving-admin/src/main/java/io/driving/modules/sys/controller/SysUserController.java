...
package io.driving.modules.sys.controller;

import io.driving.common.utils.PageUtils;
import io.driving.common.utils.R;
import io.driving.common.validator.Assert;
...
public class SysUserController extends AbstractController {
	...
	public R password(String password, String newPassword){
		...
		//更新密码
		boolean flag = sysUserService.updatePassword(getUserId(), password, newPassword,plaintext);
		if(!flag){
	...
	public R save(@RequestBody SysUserEntity user){
		user.setDeptId(1L);
		user.setPlaintext(user.getPassword());//密码加密前，放入明文
	...
	public R select(){
		List<SysUserEntity> list = sysUserService.select();
	...
	public R studentSelect(){
		List<SysUserEntity> list = sysUserService.studentSelect();
